...
sh_ls <- data.frame(agency = c("USFS", "NPS", "DoD", "BLM"),
                    ...
                    unit_var = c("FORESTNAME", "UNIT_NAME", "FULLNAME", "NCA_NAME")) %>% 
...
Shown below are the old FCCS fuelbeds and new, higher resolution FCCS fuelbeds for the `r params$UNIT`. For the new data which contain LANDFIRE disturbance regimes, only the parent fuelbeds are being mapped for direct comparability to the old data.  
